...
* 🏥🐾 **[BAU-VTH](https://github.com/t-fahim/bau-vth)**: A web application designed to modernize and enhance the management of patient records and treatment history at the Bangladesh Agricultural University Veterinary Teaching Hospital.
<!---------------------------------------
...
-------------------------------------------->
> Want to see more? Check out my [GitHub Repositories](https://github.com/t-fahim?tab=repositories) !
